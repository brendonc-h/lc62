    ...
    <ErrorBoundary>
      ...
      <main>
        ...
        <div className="relative h-screen flex items-center justify-center pt-16 overflow-hidden">
          ...
          <div className="absolute top-24 right-5 bg-orange-500 text-white px-4 py-2 rounded-full font-semibold shadow-lg transition-all duration-500 ease-in-out transform z-20">
